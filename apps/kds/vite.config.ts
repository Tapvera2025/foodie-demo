...
export default defineConfig({
  ...
  server: {
    // 5174 so the customer PWA and the kitchen can run side by side, which is
    // the only way to watch an order move from one to the other.
    port: 5174,
    ...
    // 5174 sends this app to 5175 — and you end up with two browser tabs
